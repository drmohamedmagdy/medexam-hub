...
function ResourceCard({
  ...
  return (
    <article className="group flex h-full flex-col overflow-hidden rounded-2xl border border-zinc-200 bg-white transition hover:border-blue-300 hover:shadow-md dark:border-slate-800 dark:bg-slate-900/60 dark:backdrop-blur dark:hover:border-cyan-700/60">
      {/* Cover area — image if present, gradient block with emoji otherwise */}
      <div className="relative aspect-[3/4] w-full overflow-hidden bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-slate-800 dark:to-slate-900">
        {r.coverUrl ? (
        ...
        {/* File-type chip in the corner */}
        <span className="absolute bottom-2 left-2 rounded-md bg-black/60 px-2 py-0.5 text-[10px] font-bold uppercase tracking-wide text-white backdrop-blur">
          {fileKindLabel(kind)}
        </span>
      </div>
      ...
      <div className="flex flex-1 flex-col p-4 sm:p-5">
        <h3 className="line-clamp-2 font-semibold leading-snug" title={r.title}>
          {r.title}
        </h3>
