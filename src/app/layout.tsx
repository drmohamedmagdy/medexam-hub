...
export const metadata: Metadata = {
  ...
  // PWA / installable web app metadata. The manifest lives at /manifest.webmanifest
  // (generated by src/app/manifest.ts) and the apple-touch-icon path tells
  // iOS Safari which icon to use when the user picks "Add to Home Screen".
